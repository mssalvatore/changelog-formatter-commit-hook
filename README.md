...
6. Issue references at the end of entries (e.g., `OCPSG-1234`, `GC-123456`, `AI-123`, `#123`)
...
## [1.0.0] - 2024-01-01
### Added
- A really long feature description that exceeds the maximum line length and needs to be wrapped properly. OCPSG-123
### Fixed
- Bug fix OCPSG-456,OCPSG-789
```
...
- A really long feature description that exceeds the maximum line length and
  needs to be wrapped properly. OCPSG-123
